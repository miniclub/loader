/*
	...
	Copyright (c) 1997-2019 by InterSystems.
	...
	Last Change: $Date: 2021/03/15 $
	Changelist : $Change: 4810094 $
*/
...
typedef const struct  IrisExportFuncTab {
	...
	int  CFPROTOI(IrisCheckFlags,(int *));
} IRISEFT;
...
extern	int  CFPROTOD(IrisCheckFlags,(int *));
...
#define	IRISCHECKFLAGS(ptr)	IrisCheckFlags(ptr)
...
#define	IRISCHECKFLAGS(ptr)	(*irisfunctabp->IrisCheckFlags)(ptr)
